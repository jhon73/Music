...
public class ArtistDownloadListAdapter extends RecyclerView.Adapter<ArtistDownloadListAdapter.ViewHolder> {
    ...
    public ArtistDownloadListAdapter(Context context, View.OnClickListener onClickListener) {
...
//        holder.mBinding.listArtistMain.setTag(position);
//        Utility.loadImage(searchDataList.get(position).getImage(), holder.mBinding.civArtistImage);
