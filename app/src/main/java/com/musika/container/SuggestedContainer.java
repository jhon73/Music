...
public class SuggestedContainer extends BaseContainer {
    ...
    public void homeFragment() {
        try {
            suggestedFragment = new SuggestedFragment();
            ft = getChildFragmentManager().beginTransaction();
            ft.replace(R.id.fragment_container, suggestedFragment, suggestedFragment.getClass().getSimpleName());
            ft.commit();
